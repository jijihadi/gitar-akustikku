                                        ...
                                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                <img class="media-object rounded-circle"
                                                    src="{{ url('/') }}/admin-assets/app-assets/images/portrait/small/avatar-s-5.jpg"
                                            ...
                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                class="avatar pull-up">
                                                <img class="media-object rounded-circle"
                                                    src="{{ url('/') }}/admin-assets/app-assets/images/portrait/small/avatar-s-7.jpg"
                                                    alt="Avatar" height="30" width="30">
                                            </li>
                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                class="avatar pull-up">
                                                <img class="media-object rounded-circle"
                                                    src="{{ url('/') }}/admin-assets/app-assets/images/portrait/small/avatar-s-10.jpg"
                                                    alt="Avatar" height="30" width="30">
                                            </li>
                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                class="avatar pull-up">
                                                <img class="media-object rounded-circle"
                                                    src="{{ url('/') }}/admin-assets/app-assets/images/portrait/small/avatar-s-8.jpg"
                                                    alt="Avatar" height="30" width="30">
                                            </li>
                                        </ul>
                                    </td>
                                    ...
                                    <td class="p-1">
                                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                class="avatar pull-up">
                                                <img class="media-object rounded-circle"
                                                    src="{{ url('/') }}/admin-assets/app-assets/images/portrait/small/avatar-s-1.jpg"
                                                    alt="Avatar" height="30" width="30">
                                            </li>
                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                class="avatar pull-up">
                                                <img class="media-object rounded-circle"
                                                    src="{{ url('/') }}/admin-assets/app-assets/images/portrait/small/avatar-s-2.jpg"
                                                    alt="Avatar" height="30" width="30">
                                            </li>
                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                class="avatar pull-up">
                                                <img class="media-object rounded-circle"
                                                    src="{{ url('/') }}/admin-assets/app-assets/images/portrait/small/avatar-s-3.jpg"
                                                    alt="Avatar" height="30" width="30">
                                            </li>
                                        </ul>
                                    </td>
                                    ...
                                    <td class="p-1">
                                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                class="avatar pull-up">
                                                <img class="media-object rounded-circle"
                                                    src="{{ url('/') }}/admin-assets/app-assets/images/portrait/small/avatar-s-6.jpg"
                                                    alt="Avatar" height="30" width="30">
                                            </li>
                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                data-placement="bottom" data-original-title="Elicia Rieske"
                                            ...
                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                ...
                                                class="avatar pull-up">
                                                <img class="media-object rounded-circle"
                                                    src="{{ url('/') }}/admin-assets/app-assets/images/portrait/small/avatar-s-9.jpg"
                                                    alt="Avatar" height="30" width="30">
                                            </li>
                                        </ul>
                                    </td>
